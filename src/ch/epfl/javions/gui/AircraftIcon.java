...
/**
 * Represents the different aircraft icons available
 */
public enum AircraftIcon {
    ...
    /**
     * Constructs an aircraft icon
     *
     * @param canRotate (boolean) : indicates if the aircraft can rotate
     * @param svgPath   (String) : svp path corresponding to the icon
     */
    ...
    /**
     * Determines the aircraft icon given its data
     *
     * @param typeDesignator         (AircraftTypeDesignator) : type designator
     * @param typeDescription        (AircraftDescription) : description
     * @param category               (int) : category
     * @param wakeTurbulenceCategory (WakeTurbulenceCategory) : wake turbulence category
     * @return the icon corresponding to the given information of the aircraft
     */
    ...
    /**
     * Returns true if the aircraft can rotate
     *
     * @return true if the aircraft can rotate
     */
    ...
    /**
     * Returns the svg path of the aircraft
     * @return svg path of the aircraft
     */
